---
title: 'SpaceRace V @ EPFL Rocket Team'
...
image: 'https://eliebaier.fra1.cdn.digitaloceanspaces.com/posts/space-race-v/SpaceRace-V-at-EPFL-Rocket-Team.webp'
read: 10
date: '13 July 2025'
visible: true
---
...
<Note>This post won’t be too technical, since it’s also meant for my non-technical family and friends. Too much jargon would probably bore them to death.</Note>
...
<Important>All the code is available on [my github page](https://github.com/Fayorg/ert-avionics). Keep in mind: this should only serve as a starting point. It’s not production-ready — many features are missing, and parts of the code need a rewrite, since a lot of it was rushed to get ready in time.</Important>
